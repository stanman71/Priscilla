...
int PIN_LED_RED   = 12;                          // D6
        ...
        char model[40]       = "sensor_ultrasonic";
...
void loop() {
    ...
    update_timer_counter = update_timer_counter + 10;
            ...
            // Convert the time into a distance
            int cm_5 = (duration/2) / 29.1;      


            cm = (cm_1 + cm_2 + cm_3 + cm_4 + cm_5) / 5;
